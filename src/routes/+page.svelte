...
<div class="flex flex-col md:flex-row gap-4 md:gap-8 p-4 max-w-full box-border">
    <div class="flex flex-col gap-2 leading-tight min-w-0">
        <h1 class="m-0 text-lg font-bold">{@html data.title}</h1>
        <p class="m-0 text-sm">{data.subtitle}</p>
        <p class="m-0 text-sm">{data.subtext}</p>
        <p class="m-0 text-sm mt-2">{data.subtext2}</p>
    </div>

    <div class="flex flex-col gap-1 leading-tight min-w-0">
        <h2 class="m-0 font-bold underline text-sm">Legend</h2>
